package com.ayu.realty.global.response.ErrorType;
...
public enum ErrorCode implements ErrorType {
    ...
    ACCESS_DENIED("E403", "접근이 거부되었습니다", HttpStatus.FORBIDDEN.value()),
    OAUTH2_LOGIN_FAILED("E401", "소셜 로그인에 실패했습니다. 다시 시도해주세요.", HttpStatus.UNAUTHORIZED.value()),
    INVALID_PASSWORD("E403", "잘못된 비밀번호입니다", HttpStatus.BAD_REQUEST.value()),
